...
<div class="right">
  ...
  <button type="button" class="option" style="border:none;background:none;"><span class="dot" style="background-color:gray;height:5px;width:5px;"></span>
	...
	<div style="color:#6ef0ee;margin-left:35px;font-family: Arial, sans-serif;font-size:20px;"><strong>Security Code</strong></div>
	<br>
	<div style="color:#FFFFFF;margin-left:35px;font-family: Arial, sans-serif;font-size:13px;line-height: 1.6;">
	Data Security is one of our best<br>
	facilities. Allows for your files to be<br>
	safer. The file can be secured with a<br>
	code or password that you created, so<br>
	only you can open the file.<br>
	<br><br>
	<button type="button" class="unstyled-button" style="margin-right:40px;font-size:13px;color:#6ef0ee;">Learn more<font style="color:#964fc2;">&nbsp;&nbsp;➔</font>
	</div>
	</form>
...
<br><br>
<div style="color:#FFFFFF;font-family: Arial, sans-serif;font-size:14px;letter-spacing:0.5;line-height:1.6;">
The place to store various data that you can access<br>
at any time through the internet and where you can<br>
carry it.<br>
This very flexible storage area has a high level of<br>
...
<hr style="height:2px;border-width:0;background-color:#964fc2">
<br><br><br>	
<div>
...
<br><br>
<div style="color:#6ef0ee;margin-left:200px;font-family: Arial, sans-serif;font-size:14px;">
Insignia Societ, 234<br>
...
<br>
<div style="color:#6ef0ee;">About</div><br><br><br>
...
<br>
<div class="" style="float:left;margin-left:140px;font-family: Arial, sans-serif;font-size:14px;">
<div style="color:#6ef0ee">Help</div><br><br><br>
<div style="color:#6ef0ee">
Support<br><br>
Sign up<br><br>
Guide<br><br>
